...
public class MouseCheckDisabledAdapter extends CustomMouseAdapter {
    public MouseCheckDisabledAdapter(String tipText) { super(tipText); }
    public MouseCheckDisabledAdapter(String tipText, boolean allowLongStr) { super(tipText, allowLongStr); }
    @Override
