...
For more up-to-date documents, you can refer to [Samera2022/MouseMacros | DeepWiki](https://deepwiki.com/Samera2022/MouseMacros), as it provides a "Refresh this wiki" and "Enter email to refresh" button to keep it up-to-date.
